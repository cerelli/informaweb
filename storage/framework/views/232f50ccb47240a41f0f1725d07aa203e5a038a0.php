<?php $__env->startSection("contentheader_title", "Permissions"); ?>
<?php $__env->startSection("contentheader_description", "Permissions listing"); ?>
<?php $__env->startSection("section", "Permissions"); ?>
<?php $__env->startSection("sub_section", "Listing"); ?>
<?php $__env->startSection("htmlheader_title", "Permissions Listing"); ?>

<?php $__env->startSection("headerElems"); ?>
<?php if(LAFormMaker::la_access("Permissions", "create")) { ?>
...
<div class="modal fade" id="AddModal" role="dialog" aria-labelledby="myModalLabel">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<?php echo Form::open(['action' => 'LA\PermissionsController@store', 'id' => 'permission-add-form']); ?>
...
$(function () {
	$("#example1").DataTable({
		processing: true,
        serverSide: true,
        ajax: "<?php echo e(url(config('laraadmin.adminRoute') . '/permission_dt_ajax')); ?>",
		language: {
			lengthMenu: "_MENU_",
			search: "_INPUT_",
