<div role="tabpanel" class="tab-pane fade in p20 bg-white" id="tab-access_rights">
    ...
    <form action="<?php echo e(url(config('laraadmin.adminRoute') . '/save_account_access_rights/'.$account->id)); ?>" method="post">
        ...
        <table class="table table-bordered dataTable no-footer table-access_rights" id="tablea-access_rights">
            ...
            <?php $__currentLoopData = $userAccessRights; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $userAccess): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                
                <tr>
                    <td><input module_id="<?php echo e($userAccess->account_user_id); ?>" class="module_checkb" type="checkbox" name="user_<?php echo e($userAccess->user_id); ?>" id="user_<?php echo e($userAccess->user_id); ?>" checked="checked">&nbsp; <?php echo e($userAccess->name); ?></td>
                    <td><input module_id="<?php echo e($userAccess->account_user_id); ?>" class="view_checkb" type="checkbox" name="acuser_<?php echo e($userAccess->user_id); ?>_view" id="user_<?php echo e($userAccess->user_id); ?>_view" <?php if($userAccess->acc_view == 1) { echo 'checked="checked"'; } ?> ></td>
                    <td><input module_id="<?php echo e($userAccess->account_user_id); ?>" class="edit_checkb" type="checkbox" name="acuser_<?php echo e($userAccess->user_id); ?>_edit" id="user_<?php echo e($userAccess->user_id); ?>_edit" <?php if($userAccess->acc_edit == 1) { echo 'checked="checked"'; } ?> ></td>
                    <td><input module_id="<?php echo e($userAccess->account_user_id); ?>" class="delete_checkb" type="checkbox" name="acuser_<?php echo e($userAccess->user_id); ?>_delete" id="user_<?php echo e($userAccess->user_id); ?>_delete" <?php if($userAccess->acc_delete == 1) { echo 'checked="checked"'; } ?> ></td>
                </tr>
