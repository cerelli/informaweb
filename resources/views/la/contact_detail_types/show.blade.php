...
<div id="page-content" class="profile2">
    <div class="bg-primary clearfix">
        <div class="col-md-4">
            <div class="row">
                ...
                <div class="col-md-9">
                    <h4 class="name">{{ $contact_detail_type->$view_col }}</h4>
                    <div class="row stats">
        ...
        <div class="col-md-1 actions">
            @la_access("Contact_detail_types", "edit")
                <a href="{{ url(config('laraadmin.adminRoute') . '/contact_detail_types/'.$contact_detail_type->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
            @endla_access
            
            @la_access("Contact_detail_types", "delete")
                {{ Form::open(['route' => [config('laraadmin.adminRoute') . '.contact_detail_types.destroy', $contact_detail_type->id], 'method' => 'delete', 'style'=>'display:inline']) }}
    ...
    <ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
        <li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/contact_detail_types') }}" data-toggle="tooltip" data-placement="right" title="Back to Contact detail types"><i class="fa fa-chevron-left"></i></a></li>
