...
@section("contentheader_title", "Accounts")
@section("contentheader_description", "Accounts listing")
@section("section", "Accounts")
@section("sub_section", "Listing")
@section("htmlheader_title", "Accounts Listing")
...
$(function () {
    $("#example1").DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{ url(config('laraadmin.adminRoute') . '/account_dt_ajax') }}",
        language: {
            lengthMenu: "_MENU_",
            search: "_INPUT_",
